...
o.write('Folder,Name,Num,threshold,num_regions,cut_off,border_sum,est_len,')
for i in range(1, 11):
...
o.write('BodMeanInt,BodAvgWidth,BodStdInt,BodPerct95,BodMedianInt,BodSumInt,BKMeanInt,BKStdInt,BKPerct95,BKMedianInt,BKSumInt\n')
...
for abs_directory in [f.path for f in os.scandir(args.path) if f.is_dir()]:
    ...
    for filename in glob.glob('*.png'):
        ...
        o.write(str(BKMeanInt) + ',' + str(BKStdInt) + ',')
