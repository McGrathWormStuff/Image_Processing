...
o = open('out.csv','w')
o.write('Folder,Name,Num,threshold,num_regions,cut_off,border_sum,est_len,bkMeanInt,wormMeanInt,')
for i in range(1, 11):
    o.write('MeanInt-' + str(i) + ',avgWidth-' + str(i) + ',stdInt-' + str(i) + ',perct95-' + str(i) + ',medianInt-' + str(i) + ',sumInt-' + str(i) + ',')
o.write('intRatio2-9,tipWidthRatio,')
o.write('BodMeanInt,BodAvgWidth,BodStdInt,BodPerct95,BodMedianInt,BodSumInt,BKMeanInt,BKAvgWidth,BKStdInt,BKPerct95,BKMedianInt,BKSumInt\n')
...
for abs_directory in [f.path for f in os.scandir(args.path) if f.is_dir()]:
    ...
    for filename in glob.glob('*.png'):
        ...
        for position in row2:
            if position >= 1:
                cut_off = True
        # Write cut_off to output
        o.write(str(int(cut_off)) + ',')
        ...
        # Write intensities to output
        o.write(str(bkMeanInt) + ',' + str(wormMeanInt) + ',')
        ...
        # Full bk states
        [BKMeanInt, BKAvgWidth, BKStdInt, BKPerct95, BKMedianInt, BKSumInt] = SA.stats(bk)
        o.write(str(BKMeanInt) + ',' + str(BKAvgWidth) + ',' + str(BKStdInt) + ',')
        o.write(str(BKPerct95) + ',' + str(BKMedianInt) + ',' + str(BKSumInt) + ',\n')
